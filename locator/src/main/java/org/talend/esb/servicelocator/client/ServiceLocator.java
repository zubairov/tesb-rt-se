 ...
 * <li>All live endpoints for a specific service that were registered before by other
 * clients can be looked up.</li>
 * <li>All services for which an endpoint was ever registered can be retrieved.</li>
 * <li>For a specific service all endpoints that were ever registered can be retrieved whether they
 *  are currently live or not.</li>
 * </ul>
 * 
 */
