...
public class ServiceLocatorImplTest extends AbstractServiceLocatorImplTest {
    ...
    @Test
    public void registerServiceExistsEndPointExistsNotWithProperties() throws Exception {
        pathExists(SERVICE_PATH_1);
    ...
    @Test
    public void registerServicesExistsNotButConcurrentlyCreatedByOtherClient() throws Exception {
        pathExistsNot(SERVICE_PATH_1);
