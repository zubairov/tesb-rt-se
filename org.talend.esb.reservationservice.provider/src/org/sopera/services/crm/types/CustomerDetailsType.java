 ...
 *         &lt;element name="status" type="{http://services.sopera.org/crm/types}CRMStatusType" minOccurs="0"/>
...
public class CustomerDetailsType {
    ...
    protected CRMStatusType status;
     ...
     *     
     */
    public CRMStatusType getStatus() {
        return status;
    }
     ...
     *     
     */
    public void setStatus(CRMStatusType value) {
        this.status = value;
    }
