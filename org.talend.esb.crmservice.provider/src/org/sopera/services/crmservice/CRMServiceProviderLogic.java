...
public class CRMServiceProviderLogic implements CRMService {

    private static CRMServiceProviderLogic instance;
    ...
    public static CRMServiceProviderLogic getInstance() {
    	if (instance == null) {
    		instance = new CRMServiceProviderLogic();
    	}
    	return instance;
    }
	...
	private CRMServiceProviderLogic() {
